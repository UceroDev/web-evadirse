/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0dfa5dab253a6b5d318801b45fc74251)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PIN_VALIDACION">> {}
}
